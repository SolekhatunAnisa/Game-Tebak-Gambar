...
public class Buahbibir extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_buahbibir);
  	...
  	if(jawabanUser.equals(jawabanBenar)){
  		...
  		Intent trans = new Intent(getApplicationContext(),Catur.class);
  		startActivity(trans);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.buahbibir, menu);
		return true;
	}
