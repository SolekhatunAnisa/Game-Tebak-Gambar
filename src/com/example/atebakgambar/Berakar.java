...
public class Berakar extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_berakar);
  	...
  	if(jawabanUser.equals(jawabanBenar)){
  		...
  		Intent trans = new Intent(getApplicationContext(),BosanMengangur.class);
  		startActivity(trans);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.berakar, menu);
		return true;
	}
